...
use Farol360\AncoraEad\Model\UserModel;
...
class User
{
    ...
    public static function login($email, $password)
    {
        ...
        if (!empty((array) $user) && (hash_equals($user->password, crypt($password, $user->password)))) {
    ...
    public static function setupUser(Container $container)
    {
        ...
        self::$userModel = new UserModel(self::$db);
    }
